...
description: "Set up Posessed Browser in 2 minutes"
---

Welcome to Posessed Browser! Let's get you set up.
...
<Steps>
  ...
  <Step title="Set up your AI">
    Posessed Browser includes a default AI model with limited daily usage. For the best experience, add your own.
...
Explore what Posessed Browser can do:
...
<Columns cols={2}>
  ...
  <Card title="Use with Claude Code" icon="terminal" href="/features/use-with-claude-code">
    Control Posessed Browser from Claude Code or Gemini CLI
  </Card>
</Columns>
