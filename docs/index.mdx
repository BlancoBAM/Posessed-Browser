...
<Frame>
  <img src="/images/hero-dark.png" alt="Posessed Browser in action" />
</Frame>

Posessed Browser is an AI-native browser that lets you automate any web task by describing it in plain English. Built on Chromium, it runs AI agents locally on your machine—keeping your data private while giving you superpowers for browsing.
...
<Steps>
  <Step title="Download Posessed Browser">
    Get the latest release from [github.com/BlancoBAM/Posessed-Browser/releases](https://github.com/BlancoBAM/Posessed-Browser/releases) for macOS, Windows, or Linux.
  </Step>
  ...
  <Step title="Configure your AI">
    Posessed Browser includes a default AI model with limited daily usage for testing. For the full experience, bring your own API keys.
...
<Columns cols={3}>
  ...
  <Card title="GitHub" icon="github" href="https://github.com/BlancoBAM/Posessed-Browser">
