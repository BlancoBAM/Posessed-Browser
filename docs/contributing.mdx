...
description: "Guide to contributing to Posessed Browser"
---

Posessed Browser has two main parts you can contribute to:
...
**Report bugs** — [Open an issue](https://github.com/BlancoBAM/Posessed-Browser/issues/new) with steps to reproduce, expected vs actual behavior, and screenshots.

**Suggest features** — Share ideas on [GitHub](https://github.com/BlancoBAM/Posessed-Browser/issues/99) or [Discord](https://discord.gg/YKwjt5vuKr).
...
<img src="/images/contributing--architecture.png" alt="Posessed Browser Agent architecture diagram" />

### Setup

```bash
# Clone the repo
git clone https://github.com/YOUR-USERNAME/Posessed Browser.git
...
Then load the extension in Posessed Browser:
...
**4. Run Posessed Browser**

<Tabs>
  <Tab title="macOS (ARM64)">
    ```bash
    <chromium-src>/out/Default_arm64/Posessed Browser\ Dev.app/Contents/MacOS/Posessed Browser\ Dev \
  ...
  <Tab title="macOS (x64)">
    ```bash
    <chromium-src>/out/Default_x64/Posessed Browser\ Dev.app/Contents/MacOS/Posessed Browser\ Dev \
      --enable-logging=stderr \
      --use-mock-keychain \
      --user-data-dir=/tmp/test-profile
    ```
  ...
  <Tab title="Windows">
    ```bash
    <chromium-src>\out\Default_x64\Posessed Browser Dev.exe \
      --enable-logging=stderr \
...
- **GitHub Issues** — [github.com/BlancoBAM/Posessed-Browser/issues](https://github.com/BlancoBAM/Posessed-Browser/issues)
- **GitHub Discussions** — [github.com/BlancoBAM/Posessed-Browser/discussions](https://github.com/BlancoBAM/Posessed-Browser/discussions)
