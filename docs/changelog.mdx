...
All notable changes to Posessed Browser are documented here. For the full release history with download links, see our [GitHub Releases](https://github.com/BlancoBAM/Posessed-Browser/releases).
...
<Frame>
  <img src="/images/changelog/0.39.0-sync-mcp.png" alt="Posessed Browser v0.39.0 featuring Sync and improved MCP connectors" />
</Frame>
...
- **Gemini 3 support** — Gemini 3 Pro and Flash models now work with Posessed Browser
- **Windows icon fix** — The Windows icon now displays Posessed Browser logo correctly
...
A complete revamp of Posessed Browser.
...
<Note>
For older releases, see the [full release history on GitHub](https://github.com/BlancoBAM/Posessed-Browser/releases).
</Note>
