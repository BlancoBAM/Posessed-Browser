...
Posessed Browser works great with local models for Chat Mode. Run models completely offline — your data never leaves your machine.

## Context Length

<Warning>
**Ollama defaults to 4,096 tokens of context — this is too low for Posessed Browser.** Below 15K tokens, the context overflows and the agent gets stuck in a loop constantly trying to recover. Only Chat Mode will work at low context lengths. Set at least **15,000–20,000 tokens** for local models to function properly.
</Warning>
...
<Tabs>
  <Tab title="Ollama" icon="terminal">
    ...
    <Steps>
      ...
      <Step title="Configure in Posessed Browser">
        ...
        ![Ollama in Posessed Browser](/images/byollm--ollama-config.png)
      </Step>
    </Steps>
  </Tab>
  <Tab title="LM Studio" icon="desktop">
    ...
    <Steps>
      ...
      <Step title="Configure in Posessed Browser">
        ...
        ![LM Studio in Posessed Browser](/images/byollm--lmstudio-config.png)
      </Step>
    </Steps>
  </Tab>
</Tabs>
