...
<Steps>
  ...
  <Step title="Grant access">
    Allow Posessed Browser to access that folder when prompted
  </Step>
</Steps>
...
Filesystem Access is a new feature. If you have feedback or feature requests, [open a GitHub issue](https://github.com/BlancoBAM/Posessed-Browser/issues).
