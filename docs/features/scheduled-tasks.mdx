...
description: "Run the Posessed Browser agent automatically on a schedule"
---

Scheduled Tasks let you run the Posessed Browser agent automatically—daily, every few hours, or every few minutes. You get the full power of the agent running on autopilot.
...
<Note>
Posessed Browser needs to be open for scheduled tasks to run. If your laptop was closed or Posessed Browser wasn't running at the scheduled time, the task will run as soon as you open Posessed Browser again.
</Note>
