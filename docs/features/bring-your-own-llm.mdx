...
description: "Connect your own AI models to Posessed Browser"
---

Posessed Browser includes a default AI model you can use right away, but it has strict rate limits. For the best experience, bring your own API keys or run models locally.
